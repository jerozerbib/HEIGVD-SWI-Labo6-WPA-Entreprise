...
- Comparer [la capture](files/auth.pcap) au processus d’authentification donné en théorie (n’oubliez pas les captures d'écran pour illustrer vos comparaisons !). En particulier, identifier les étapes suivantes :
	...
	![](./files/auth_open_system.png)

 - Requête et réponse d’association (ou reassociation)

	![](./files/Reassocioation_request.png)

 - Négociation de la méthode d’authentification entreprise

  ![](./files/negociation1_of_3.png)

  ![](./files/negociation2_of_3.png)

  ![](./files/negociation3_of_3.png)

 - Phase d’initiation. Arrivez-vous à voir l’identité du client ?

 ![](./files/Identity.png)
 L'identité du client est einte\\joel.gonin
	- Phase hello :
		- Version TLS
...
![](./files/client_hello.png)

![](./files/server_hello.png)

  - Phase de transmission de certificats
	 - Echanges des certificats
	 - Change cipher spec

![](./files/change_cipher_spec.png)

- Authentification interne et transmission de la clé WPA (échange chiffré, vu comme « Application data »)

![](./files/application_data.png)

- 4-way handshake

![](./files/4_way_handshake.png)
...
>
> **_Réponse :_** EAP-TLS et PEAP sont proposés.

---

> **_Question:_** Quelle méthode d’authentification est finalement utilisée ?
>
> **_Réponse:_** C'est PEAP qui est retenu.
...
>
> **_Réponse:_** Oui, pour valider son identité.
>
> - b. Le client envoie-t-il un certificat au serveur ? Pourquoi oui ou non ?
>
> **_Réponse:_** Non, dans PEAP, le client n'a pas a envoyer de certificat, contrairement à EAP-TLS (la gestion des certificats peut être problématique).
>
